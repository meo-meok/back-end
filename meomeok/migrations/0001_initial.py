# Generated by Django 4.0.6 on 2022-08-12 13:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restaurant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='meomeok.restaurant')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='meomeok.users')),
            ],
        ),
        migrations.CreateModel(
            name='menu_price',
